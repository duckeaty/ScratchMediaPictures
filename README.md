...
***11。支持单独设置抓取横竖图的长宽比,填写规范为“16/9”，“16：9”，“16:9”三种。***

20260723更新：
1、新增可拖动、缩放的红色裁剪框，支持横竖比例切换。
2、截图统一保留完整画面，裁剪时按选定区域生成封面或缩略图。
3、升级批量处理，可单独调整每张图片，勾选后统一应用。
4、自动识别媒体目录中已有的封面和缩略图。
5、支持提取任务断点续传，重启后跳过已完成内容。
6、优化图片排序、列表位置记忆和选图状态显示。
